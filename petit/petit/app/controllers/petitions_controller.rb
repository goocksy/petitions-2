class PetitionsController < ApplicationController
  ...
  def upvote
    ...
    if current_user.present?
      if @petition.votings.where(surname: current_user.surname, name: current_user.name, patronymic: current_user.patronymic, age: current_user.age).present?
        redirect_to action: :show
      else    
        @petition.increment!(:votes)
        @petition.votings << (Voting.create surname: current_user.surname, name: current_user.name, patronymic: current_user.patronymic, age: current_user.age)
        redirect_to action: :show
